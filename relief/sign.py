...
def build(params):
    ...
    border_width = float(params.get("border_width", 2))
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="CadQuery sign with border frame generator")
